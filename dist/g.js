...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return help; });\n/* harmony import */ var _ctrl__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../ctrl */ \"./src/ctrl.js\");\n/* harmony import */ var _vertex__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../vertex */ \"./src/vertex.js\");\n/* harmony import */ var _lib_v2c__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../lib/v2c */ \"./src/lib/v2c.js\");\n\n\n\n\nclass help {\n  constructor() {\n    this.data = new _vertex__WEBPACK_IMPORTED_MODULE_1__[\"Vertex\"](new _lib_v2c__WEBPACK_IMPORTED_MODULE_2__[\"default\"](3,3), 'data', 1)\n    this.data.consumed = false\n    this.data.a = 1\n    this.gateOpen = new _vertex__WEBPACK_IMPORTED_MODULE_1__[\"Vertex\"](new _lib_v2c__WEBPACK_IMPORTED_MODULE_2__[\"default\"](3,4), 'gate', 0)\n    this.gateOpen.a = 1\n    this.gateClosed = new _vertex__WEBPACK_IMPORTED_MODULE_1__[\"Vertex\"](new _lib_v2c__WEBPACK_IMPORTED_MODULE_2__[\"default\"](3,5), 'gate', 2)\n    this.gateClosed.a = 1\n  }\n  d() {\n    ctx.font = \"16px Arial\"\n    ctx.fillStyle = 'rgba(0,0,0,.5)'\n    ctx.fillRect(20,20, C_WIDTH - 40, C_HEIGHT - 40)\n    ctx.fillStyle = '#8f949a'\n    ctx.fillText('Data', 120, 95)\n    ctx.fillText('Open gate', 120, 125)\n    ctx.fillText('Closed gate', 120, 155)\n    this.data.d()\n\n    this.gateOpen.d()\n    this.gateClosed.d()\n  }\n\n  k() {\n    if(!press[_ctrl__WEBPACK_IMPORTED_MODULE_0__[\"default\"].HELP]) {\n      window.gameState = 'play'\n    }\n    return this\n  }\n}\n\n//# sourceURL=webpack:///./src/menus/help.js?");

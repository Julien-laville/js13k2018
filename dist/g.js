...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./player */ \"./src/player.js\");\n/* harmony import */ var _network__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./network */ \"./src/network.js\");\n/* harmony import */ var _ctrl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ctrl */ \"./src/ctrl.js\");\n/* harmony import */ var _editor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor */ \"./src/editor.js\");\n/* harmony import */ var _background__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./background */ \"./src/background.js\");\nconst C_WIDTH = 400\nconst C_HEIGHT = 800\nwindow.log=(m)=>console.log(m)\n\n\n\n\n\nObject(_ctrl__WEBPACK_IMPORTED_MODULE_2__[\"default\"])()\n\n\nconst netork0 = {\n  w:5,\n  h:5,\n  edges : [\n    [2,7,-1],\n    [6,7,1],\n    [7,8,1],\n    [10,11,1],\n    [6,11,1],\n    [7,12,1],\n    [8,13,1],\n    [11,12,1],\n    [13,14,1],\n    [11,16,1],\n    [13,18,1],\n    [16,17,1],\n    [17,18,1],\n    [17,22,-1],\n  ],\n  vertices : [\n    {id : 10, t : 'start'},\n    {id : 2, t : 'data'},\n    {id : 14, t : 'gate', th : 2},\n    {id : 22, t : 'data'}\n  ]\n}\nconst editor = new _editor__WEBPACK_IMPORTED_MODULE_3__[\"Editor\"]\nconst w = new _network__WEBPACK_IMPORTED_MODULE_1__[\"default\"](netork0)\nwindow.p = new _player__WEBPACK_IMPORTED_MODULE_0__[\"default\"](netork0, w)\nconst background = new _background__WEBPACK_IMPORTED_MODULE_4__[\"default\"](netork0)\nwindow.ctx = c.getContext('2d')\nc.width = C_WIDTH\nc.height = C_HEIGHT\nctx.fillStyle = '#000'\nctx.fillRect(0,0,C_WIDTH,C_HEIGHT)\nlet gameState = 'editor'\n\nlet ll = () => {\n  c.width+=0\n  background.l()\n  background.d()\n  if(gameState === 'menu') {\n\n  } else if(gameState === 'game') {\n    p.k() // player\n    w.k() // world\n\n    w.d()\n    p.d()\n  } else if(gameState === 'editor'){\n    editor.d()\n  }\n\n  requestAnimationFrame(ll)\n}\nll()\n\n\n\n\n//# sourceURL=webpack:///./src/game.js?");
